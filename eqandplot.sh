...
python3 src/equilibrium.py translated.json data/test10/connections_all.json 1000 0.01
#python3 src/equilibrium.py translated.json data/test10/equal_connections.json 1000 0.01
