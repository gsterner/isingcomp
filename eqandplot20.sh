...
python3 src/equilibrium.py data/test20/start_spins.json data/test20/norm_sim_conn_20.json 10000 0
python3 src/system_translation.py spins_output.json data/test20/end.csv
